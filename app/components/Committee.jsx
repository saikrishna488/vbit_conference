            ...
            <div className="mb-6">
                <div className="flex justify-between">
                    <div className="w-1/2 pr-2">
                        ...
                        <br />
                        <p>Ming Yang, Kennesaw State University, Atlanta, USA</p>
                        <p>Sanjay Misra</p>
                        <p>Milos Stojmenovic</p>
                        <p>Georgios Tsaramirsis</p>
                        <p>Sven Groppe</p>
                        <p>Mohammad Yamin</p>
                        <p>Mukesh Misra</p>
                        <p>Neha Mohanty</p>
                        <p>Jinghua Groppe</p>
                        <p>Abdulrhman Alshareef</p>
                        <p>Gourav Gupta</p>
                        <p>Lal Hussain</p>
                        <p>María Avilés</p>
                        <p>Izzat Al-Darraji</p>
                        <p>Lie Li</p>
                        <p>Abdulsattar Abdullah Hamad</p>
                        <p>Vicente Garcia Diaz</p>
                        <p>Oscar Castillo</p>
                        <p>J P Das</p>
