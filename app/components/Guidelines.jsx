...
const Guidelines = () => {
  return (
    ...
    <div className=" mx-auto p-8 bg-white">
      ...
      <p className="mb-4">The proceedings of IC-ACIST-2024 will be published in the Springer Book series “Lecture Notes in Networks and Systems (LNNS)”, which will be Indexed by SCOPUS, INSPEC, WTI Frankfurt eG, zbMATH, SCImago. All books published in the series are submitted for consideration in Web of Science.</p>
      <p className="mb-4">All submissions must comply with the <a href="https://www.springer.com/gp/authors-editors/conference-proceedings/editors/word-template/19338734" className="text-blue-500 hover:underline">Springer format</a>.</p>
      <p className="mb-4">Before submission, <a href="https://www.springer.com/de/authors-editors/editors/publishing-ethics-for-journals/4176" className="text-blue-500 hover:underline">click here</a> to read the Springer publication ethics and guidelines.</p>
      <p className="mb-4">Paper Submission Deadline: 30th May 2024</p>
